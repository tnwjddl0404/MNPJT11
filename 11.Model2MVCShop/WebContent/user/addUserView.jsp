...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group"> <!--offset 칼럼 왼쪽에  공백을 두고싶은 만큼 할당하는 클래스  -->
		    ...
		    <div class="col-sm-3">
		      <button type="button" id="chkDupli" class="btn btn-default">중복확인</button>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" id="addUserBtn" class="btn btn-default"  >가 &nbsp;입</button>
